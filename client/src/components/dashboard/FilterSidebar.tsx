...
export function FilterSidebar({
  ...
  return (
    <aside className={`w-full xl:w-[300px] h-fit xl:sticky xl:top-24 z-10 ${className}`}>
      <DashboardCard padding="sm" className="flex flex-col gap-6">
        ...
        {conditions && onConditionChange && (
          <div className="flex flex-col gap-3">
            <label className="text-[11px] font-extrabold uppercase tracking-widest text-on-surface-muted">Condition</label>
            <select
